...
function ProjectUiUx({ children, title = 'UI/UX', UiDemo, project = null }) {
  ...
  return (
    <div className='flex-center gap-10 w-full min-w-8/10'>
      <div className='flex flex-col gap-4 w-1/3 h-full max-h-full bg-bgr/80 border border-pri/30 rounded-xs shadow-xl shadow-sdw/30'>
        {UiDemo}
      </div>
